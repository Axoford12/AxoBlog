...
<div class="per_upload_con" data-url="<?=$config['serverUrl']?>">
    ...
    <div class="per_upload_text">
        <p class="upbtn" ><a id="<?=$attribute?>" href="javascript:;" class="btn btn-success green choose_btn">选一张可爱的图片吧！</a></p>
        <p class="rule">Axo还仅仅支持文件格式为jpg、jpeg、png以及gif<br>大小在1MB以下的文件呢！</p>
    </div>
