                    ...
                    <div class="row">
                        <div class="col-lg-4 label-img-size">
                            <a href="#" class="post-label">
                                ...
                                ?>
                                <img  class="img-responsive" src="<?=$labelImgSrc ?>">
                            </a>
                        </div>
                        ...
                        <span class="glyphicon glyphicon-comment"></span><a href="<?=\yii\helpers\Url::to(['post/view','id'=>$list['id']])?>"><?=isset($list['extend']['comment'])?$list['extend']['comment']:0?></a>
                    </span>
